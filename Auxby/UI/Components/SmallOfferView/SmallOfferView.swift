...
class SmallOfferView: UIView {
    ...
    @IBOutlet weak var titleTrailingConstrait: NSLayoutConstraint!
    ...
    func setView(offer: Offer, addToFav: (() -> Void)?, viewOffers: (() -> Void)?, showUsers: (() -> Void)?) {
        ...
        titleTrailingConstrait.constant = offer.isPromoted ? 88 : 16
        //setExtraView()
...
private extension SmallOfferView {
    func setView() {
        Bundle.main.loadNibNamed("SmallOfferView", owner: self, options: nil)
